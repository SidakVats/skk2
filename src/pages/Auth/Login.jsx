...
const Login = () => {
  return (
    ...
    //     <div className="pt-10">
    //     <h1 className="text-[#002d74] text-2xl md:text-4xl">Welcome to SKK</h1>
    //     <h3 className="text-[#002d74] text-base">Crafting Dreams into Designs</h3>
    //     </div>
    //   </div>
    ...
    //     </div>
    //   </section>
    //   <div className="bg-[#f9fafb] mb-5">
    //     <p className="dark:text-gray-200 text-gray-700 text-center">
    //       {`© ${new Date().getFullYear()} All rights reserved by SKK.com`}
    //     </p>
    //   </div>
    // </div>
